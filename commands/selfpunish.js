...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (subcommand === "ban") {
            await interaction.guild.members.ban(user, { reason: "bro u literally wanted to get banned :P" });
            user.send({
                embeds: [
                    {
                        color: 0xff4816,
            ...
            await interaction.guild.members.kick(user, { reason: "bro u literally wanted to get kicked :P" });
            user.send({
                embeds: [
                    {
                        color: 0xff4816,
