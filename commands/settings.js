...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => subcommand.setName("3warn").setDescription("Choose what to do on 3 warns").addNumberOption(option => option.setName("action").setDescription("1 = kick, 2 = ban, 3 = mute").setRequired(true))),
