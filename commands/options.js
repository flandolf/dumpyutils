                ...
                if (!message.member.permissions.has(Permissions.FLAGS.KICK_MEMBERS) ||
                    ...
                    return message.channel.send({
                        embeds: [{
                            ...
                            description: "You need to have the KICK MEMBERS / ADMINISTRATOR permission to use this command!",
                        },],
                    });
                } else {
                    switch (args[1]) {
                        ...
                        default:
                            return message.channel.send({
                                embeds: [{
                                    color: "#F04A47",
                                    title: "3 Warn",
                                    description: `Please provide a valid option (kick, ban, nothing)\n Currently set to ${db.get(
                                        `${message.guild.id}.3warn`
                                    )}`,
                                },
                                ],
                            });
