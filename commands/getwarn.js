...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addUserOption(option => option.setName("user").setDescription("The user to check how many warns they have").setRequired(true)),
    async execute(interaction) {
        ...
        if (warns.length == 0) {
            ...
            warns.forEach((warn) => {
                ...
                const time = moment(parseInt(id.toString().split('_')[1])).format("MMM Do YYYY, h:mm:ss a");
                fields.push({
