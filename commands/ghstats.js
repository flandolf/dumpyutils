...
module.exports = {
    ...
    async execute(interaction) {
        ...
        async function mostRecentGithubCommit() {
            const { data } = await axios.get('https://api.github.com/repos/dumpydev/dumpyutils/commits');
        ...
        async function githubCreationDate() {
            const { data } = await axios.get('https://api.github.com/repos/dumpydev/dumpyutils');
